  ...
  return (
    <div className='w-full bg-[#fafafa]'>
      ...
      <div className="flex justify-center gap-4 mt-6">
        <Link className="hero-button bg-white shadow-sm hover:shadow-md border border-gray-200 text-gray-700 transition font-medium text-sm flex items-center gap-2 rounded-md group z-2">
          <span className="w-2 h-2 rounded-full bg-gray-400 transition group-hover:bg-green-500"></span>
          Talk to Sales
        </Link>
        <Link to='/signup' className="hero-button bg-black text-white font-medium hover:opacity-90 transition text-sm z-2" style={{ borderRadius: '5px' }}>
          Start Free Trial
        </Link>
      </div>
